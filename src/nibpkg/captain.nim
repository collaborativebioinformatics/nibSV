...
proc main_runner*(variants_fn, refSeq_fn, reads_fn: string, prefix = "test", kmer_size: int = 25, spaced_seeds : bool = false, space: int = 50, flank: int = 100, maxRefKmerCount : uint32 = 1 ) =
